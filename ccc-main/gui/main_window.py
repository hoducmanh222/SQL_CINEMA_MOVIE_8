...
from gui.cinema_room_management import CinemaRoomManagementFrame
...
class MainWindow(tk.Tk):
    ...
    def setup_layout(self):
        ...
        # Cinema Room Management (admin only)
        if self.role == "admin_user":
            movies_menu.add_command(label="Cinema Room Management",  
                                   command=lambda: self.show_frame(CinemaRoomManagementFrame))
    ...
    def initialize_frames(self):
        ...
        if self.role == "admin_user":
            frame_classes = [MovieManagementFrame, ScreeningManagementFrame, CinemaRoomManagementFrame, CustomerManagementFrame, 
